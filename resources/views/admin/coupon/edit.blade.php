                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" value="{{ $coupon->code }}" name="code" id="code" class="form-control" placeholder="Coupon Code">	
                                <p></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" value="{{ $coupon->name }}" name="name" id="name" class="form-control" placeholder="Coupon Code Name" >	
                                <p></p>
                            </div>
                        </div>		
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" value="{{ $coupon->min_amount }}" name="min_amount" id="min_amount" class="form-control" placeholder="Min Amount" >	
                                <p></p>
                            </div>
                        </div>
                        <div class="col-md-6">
...
@section('customJs')
	...
	$('#discountForm').submit(function(event){
        ...
        var element = $(this);  // discountForm Selector
