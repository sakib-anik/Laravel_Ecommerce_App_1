                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <input class="custom-control-input" value="Yes" type="checkbox" id="track_qty" name="track_qty" {{ ($product->track_qty == 'Yes') ? 'checked' : '' }}>
...
<script>
    ...
    $('#productForm').submit(function(event){
        // Form actual submission is restricted 
