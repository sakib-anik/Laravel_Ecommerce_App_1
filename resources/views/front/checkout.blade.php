                    ...
                    <div class="card shadow-lg border-0">
                        <div class="card-body checkout-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <input type="text" value="{{ (!empty($customerAddress)) ? $customerAddress->apartment : '' }}" name="apartment" id="apartment" class="form-control" placeholder="Apartment, suite, unit, etc. (optional)">
                                    </div>            
                                </div>

                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <input type="text" value="{{ (!empty($customerAddress)) ? $customerAddress->city : '' }}" name="city" id="city" class="form-control" placeholder="City">
                                        <p></p>
                                    </div>            
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <input type="text" value="{{ (!empty($customerAddress)) ? $customerAddress->state : '' }}" name="state" id="state" class="form-control" placeholder="State">
                                        <p></p>
                                    </div>            
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <input type="text" value="{{ (!empty($customerAddress)) ? $customerAddress->zip : '' }}" name="zip" id="zip" class="form-control" placeholder="Zip">
                                        <p></p>
                                    </div>            
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <input type="text" value="{{ (!empty($customerAddress)) ? $customerAddress->mobile : '' }}" name="mobile" id="mobile" class="form-control" placeholder="Mobile No.">
                                        <p></p>
                                    </div>            
                                </div>
