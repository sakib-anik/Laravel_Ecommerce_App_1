...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('discount_coupons', function (Blueprint $table) {
            ...
            // The human readable discount coupon code name // for backend purpose
            $table->string('name')->nullable();

            // The description of the coupon - Not necessary
            $table->text('description')->nullable();

            // The max_uses the discount coupon has
            ...
            // The min_amount for getting discount
            $table->double('min_amount',10,2)->nullable();

            $table->integer('status')->default(1);      // 0 [ deactive ] or 1 [ active ]
