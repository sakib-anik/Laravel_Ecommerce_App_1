                        ...
                        <div class="card product-card">
                            <div class="product-image position-relative">
                                ...
                                @if (!empty($productImage->image))
                                    <img class="card-img-top" src="{{ asset('uploads/product/small/'.$productImage->image) }}" class="img-thumbnail" style="height: 260px"></td>
                                @else
                                    <img src="{{ asset('admin-assets/img/default-pro.jpg') }}" class="card-img-top" style="height: 260px"></td>
                                @endif
                                </a>
...
@section('customJs')
    <script>
        ...
        rangeSlider = $(".js-range-slider").ionRangeSlider({
            type: "double",     // rangeSlider er jonne
            min: 0,
            max: 1000,
            from: {{ ($priceMin) }},
            step: 10,
        ...
        var slider = $(".js-range-slider").data("ionRangeSlider");  // slider er value slider er maddhome pabo
