                                ...
                                <div class="row align-items-center">
                                    <div class="col-4 col-md-3 col-xl-2">
                                        ...
                                        @if (!empty($productImage->image))
                                            <img class="img-fluid" src="{{ asset('uploads/product/small/'.$productImage->image) }}" class="img-thumbnail" style="height: 90px"></td>
                                        @else
                                            <img src="{{ asset('admin-assets/img/default-pro.jpg') }}" class="img-fluid" style="height: 90px"></td>
                                        @endif
                                    </div>
                                    <div class="col">
                                        <!-- Title -->
