                                ...
                                <td class="text-start">
                                    <div class="d-flex align-items-center">
                                        @if (!empty($item->options->productImage->image))
                                            <img src="{{ asset('uploads/product/small/'.$item->options->productImage->image) }}" class="img-thumbnail" style="">
                                        @else
                                            <img src="{{ asset('admin-assets/img/default-pro.jpg') }}" class="img-thumbnail" style="">
                                        @endif
                                        <h2>{{ $item->name }}</h2>
                                    </div>
                                </td>
